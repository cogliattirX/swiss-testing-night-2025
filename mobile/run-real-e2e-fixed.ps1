...
Write-Host "`n🔄 Starting Appium server check..." -ForegroundColor Green
...
if (Test-Path "test-results\screenshots") {
    $screenshots = Get-ChildItem -Path "test-results\screenshots\real_e2e_*.png" -ErrorAction SilentlyContinue
